...
- Colores por categoría de producto en `ProductCatalog.tsx` (`#0288D1` Nevera, `#6D4C41` Máquina, `#E64A19` Comida Rápida, `#C2185B` Confitería, `#FFC107` default/top-seller, también usado en `TableMap.tsx` para el total de mesa ocupada): reconocimiento visual rápido por categoría
